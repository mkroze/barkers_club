...
const TrainingOffers = () => {
    const [offers,setOffers] = useState([
		...
		},
		{
			...
			pricing:"350",
			listOfPerks:[
				"Dressage intermediaire",
				"Moyen exercice physique",
				"5 commandes apprises"
			]
		},
		{
			title:"Big Barker",
			...
			listOfPerks:[
				...
				"8 commandes apprises"
			]
		}
	])
    return ( offers.map((offer)=>{
        return(<div class="flex flex-col flex-grow overflow-hidden bg-white rounded-lg shadow-lg mr-2 ">
