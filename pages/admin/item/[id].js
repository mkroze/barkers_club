...
export default function AdminItemEditScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`/api/admin/items/${itemId}`);
  ...
  const submitHandler = async ({
    ...
    try {
      ...
      await axios.put(`/api/admin/items/${itemId}`, {
        name,
        slug,
        price,
        category,
      ...
      <div className="grid md:grid-cols-4 md:gap-5">
        ...
        <div className="md:col-span-3">
          {loading ? (
            ...
            >
              <h1 className="mb-4 text-xl">{`Edit Item ${itemId}`}</h1>
              <div className="mb-4">
