...
const Login = (props) =>{
    ...
    <div className="text-center mt-24">
        ...
        <span className="text-sm">or <a href="/Login/Subscribe"onclick={handleClick} className="text-green-500"> 
    ...
    <form className="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
        ...
        <div className="w-full md:w-full px-3 mb-6">
            <button className="appearance-none block w-full bg-green-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-green-400 focus:outline-none focus:bg-white focus:border-gray-500">Sign in</button>
        </div>
...
//     <form>
//         <fieldset>Priere de renseigner vos identifiants de connexion</fieldset>
//         <div classNameName="couple">
...
//         <button classNameName="py-3 px-4 text-white bg-green-600 hover:bg-gray-700 rounded-md shadow">Se connecter</button>
//     </form>
}
